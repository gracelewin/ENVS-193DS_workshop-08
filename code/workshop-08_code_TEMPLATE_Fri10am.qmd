...
AICc(model0,
     ...
     model2,
     model3,
     model4, #best model: water treatment and species
     model5,
     model6,
     model7) |> 
...
Across water streatments, all species have different(and higher) masses than _Lotus scoparius_ except _Penstemon centranthifolius_
